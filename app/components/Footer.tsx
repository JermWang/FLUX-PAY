      ...
      <div className="swap-footer-inner">
        <div className="swap-footer-content">
          <div className="swap-footer-brand">
            <img src="/branding/WHITE-LOGO.png" alt="FLUX" className="swap-footer-logo" />
            <div className="swap-footer-brand-text">
              <span className="swap-footer-name">FLUX</span>
          ...
          <div className="swap-footer-links">
            ...
            <div className="swap-footer-section">
              <h4>Community</h4>
              <a href="https://x.com/fluxpayfinance" target="_blank" rel="noopener noreferrer">Twitter</a>
        ...
        <div className="swap-footer-bottom">
          <span>© 2025 FLUX. All rights reserved.</span>
